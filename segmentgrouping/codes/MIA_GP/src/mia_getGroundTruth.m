function poly_seg_groups = mia_getGroundTruth(gt_path, segments)
%Get the ground truth from the images, if the boundaries are known
%
%   Input:
%   gt_path = file with boundaries
%   sements - contour segments
%   Output:
%   poly_seg_groups the result of segment grouping
.zafari@lut.fi
